          ...
          <div className="flex items-start gap-16">
            <div className="flex-1">
              ...
              <p className="mt-4 text-gray-200 leading-relaxed">
                ...
                Vamos também realizar o setup do nosso projeto no GraphCMS criando as entidades da aplicação 
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                <div className="leading-relaxed">
                  ...
                  <span className="etxt-gray-200 text-sm block">CTO at Rocketseat</span>
                </div>
              </div>
            </div>
          ...
          <div className="gap-8 mt-20 grid grid-cols-2">
            ...
            <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
              ...
              <div className="py-6 leading-relaxed">
                ...
                <p className="text-sm text-gray-200 mt-2">
                  Baixce wallpapers exclusivos do Ignite Lab e personalize a sua máquina
                </p>
              </div>
              <div className="h-full p-6 flex items-center">
                <CaretRight size={24} />
